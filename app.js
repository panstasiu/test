...
function renderCart(){
  const items=$("#cartItems"),total=$("#cartTotal");if(!items)return;
...
const filters=$("#filters"),filterToggle=$("[data-filter-toggle]");filterToggle?.addEventListener("click",()=>filters?.classList.toggle("show"));
