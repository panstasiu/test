...
render();
form?.addEventListener("submit",async e=>{e.preventDefault();if(!cart.length){notify("Dodaj produkt do torby.");return}const data=Object.fromEntries(new FormData(form));
